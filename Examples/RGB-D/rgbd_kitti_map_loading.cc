...
int main(int argc, char **argv)
{
    ...
    {
        cerr << endl
             << "Usage: ./rgbd_kitti path_to_vocabulary path_to_settings path_to_sequence path_to_map" << endl;
        return 1;
    }
    ...
    //ORB_SLAM3::System SLAM(argv[1], argv[2], ORB_SLAM3::System::RGBD, true, argv[4]);
